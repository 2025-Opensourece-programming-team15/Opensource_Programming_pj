...
### 1. 아카라이브 크롤러 (`src/arca_scraper.py`)
...
### 3.1. DC 인사이드 크롤러 (`src/dc_scraper.py`)

이 모듈은 디시인사이드의 특정 갤러리 또는 게시물을 조회하고 데이터를 처리하는 기능을 수행합니다.

#### 3.1.1. 갤러리 목록 검색 (`get_regular_post_data`)
...
#### 3.1.2. 통합 검색 (`get_integrated_search_data`)
